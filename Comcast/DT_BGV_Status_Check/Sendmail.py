...
def Sendmail(recipient_emails, cc_emails, subject, body_message, body_message1, body_message2, attachment_path):
...
if __name__ == "__main__":
    ...
    Sendmail(recipient_emails, cc_emails, subject, body_message, body_message1, body_message2, attachment_path)
