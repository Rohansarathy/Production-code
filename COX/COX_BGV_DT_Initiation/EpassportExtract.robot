...
Epassport_Extract
    ...
    TRY
        ...
        Execute Sql String    UPDATE cox_onboarding SET dt_confirmation_number = '${Conformation_No}' WHERE SSN = '${Alldatas}[ssn]'
        ...
        Execute Sql String    UPDATE cox_onboarding SET dt_eta = '${ETA_Date}' WHERE SSN = '${Alldatas}[ssn]'
