...
cd /d "C:\Users\Administrator\OneDrive - ITG Communications, LLC\onboarding_data\Onboarding_Spectrum\BGV_DT_Initiation"
...
C:\Users\Administrator\AppData\Local\Programs\Python\Python311\python.exe -m robot "C:\Users\Administrator\OneDrive - ITG Communications, LLC\onboarding_data\Onboarding_Spectrum\BGV_DT_Initiation\Spectrum_Initiation_Main.robot"
