...
credentials = {
    ...
    "Logfile" : "C:\\Users\\Administrator\\OneDrive - ITG Communications, LLC\\onboarding_data\\Onboarding_Spectrum\\Log\\BGV_Dt_Statuscheck",
    "ybotID" : "ybot@i-t-g.net",
    "Spectrum_team" : "kkumar@i-t-g.net,pprakash@i-t-g.net",
